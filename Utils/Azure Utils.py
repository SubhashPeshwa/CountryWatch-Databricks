...
datagov_api_key = get_secret("kvdevaue-secret-scope","DATA-GOV-API-KEY")
...
required_mounts = {"fusion-muddyboots":"/mnt/fusion-muddyboots","fusion-informed365":"/mnt/fusion-informed365", "fusion-deltalake":"/mnt/fusion-deltalake", "fusion-rms-id-report":"/mnt/fusion-rms-id-report" , "fusion-raw":"/mnt/fusion-raw", "fusion-rms":"/mnt/fusion-rms","fusion-productrecord":"/mnt/fusion-productrecord","fusion-productspec":"/mnt/fusion-productspec","fusion-productrecord-list":"/mnt/fusion-productrecord-list","fusion-productspec-list":"/mnt/fusion-productspec-list","fusion-mdm":"/mnt/fusion-mdm"}
...
for source_mount,mount_path in required_mounts.items():
  if mount_path not in all_mounts:
    mount_storage(mount_path = mount_path,
      datalake_name = get_secret("KV-MERCH-OBI-secret-scope","Fusion-storage-account-name"),
      datalake_key =  get_secret("KV-MERCH-OBI-secret-scope","Fusion-storage-access-key"),
